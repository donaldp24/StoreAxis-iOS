...
const CGFloat kBottomBarHeight = 40;
...
- (void)setupButtons {
    ...
    CGFloat yOffset = self.frame.size.height - kButtonSpace - /*kButtonPadding -*/ floorf(kButtonHeight/2) - kBottomBarHeight;
...
- (CGFloat)calculateSheetHeight {
    return ((kButtonHeight * self.buttons.count) + ((self.buttons.count-1) * kButtonPadding) + kButtonSpace*3 /*kButtonHeight/2*/ + kBottomBarHeight) /*+ 4*/;
}
